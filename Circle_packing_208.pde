...
// https://github.com/rupertrussell/Circle-Packing-208
// http://colorbrewer2.org/?type=diverging&scheme=PRGn&n=11

color[] rainbow = {#000000, #f7fcfd, #e5f5f9, #ccece6, #99d8c9, #66c2a4, #41ae76, #238b45, #006d2c, #00441b};
ArrayList<Circle> circles = new ArrayList<Circle>();

int counter = 0;
int saveCount = 0;
int sizeOfColourArray = 10;
int margin = 1500;
int min = 10;
float max = margin *.4;
